    ...
    <section id="Location" className="max-w-full flex flex-col items-center bg-white">
      ...
      <div className="w-full flex flex-col md:flex-row items-center py-7 md:py-14 gap-6 md:gap-14">
        ...
        <div className="flex flex-col items-center md:items-start w-full px-6 md:pl-[7.5rem] md:justify-between gap-6 text-center md:text-left lg:max-w-lg"> 
          ...
          <div className="flex md:flex-col items-center md:items-start w-full  md:px-2 gap-2 md:gap-6 ">
            ...
            <ol className='text-left font-body text-xs md:text-base list-disc font-medium pl-1 md:pl-5 hidden sm:block space-y-3'>
                            ...
                            <li>Opposite to Mythri Sapphire</li>
                            <li>RGA Tech Park Bengaluru - 4.7Kms</li>
                            <li>Harvest International School - 1.5Kms</li>
                            <li>D Mart - 5 Kms</li>
                            <li>Wipro Technologies - 6.3Kms</li>
          ...
          <div className="text-center md:text-left w-fit">
            <Button 
              ...
              onClick={() => window.open("https://maps.app.goo.gl/q9chDpU9CumAh3bL9", "_blank")} // Opens Google Maps link in a new tab
            />
          </div>
        </div>
              {/* Google Maps Iframe */}
        <div className="w-full flex justify-center">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3696.9093562389426!2d77.70141617507495!3d12.88512338742237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae13004fc602dd%3A0x645997eb1a1db8a3!2sBirla%20Evara!5e1!3m2!1sen!2sin!4v1768628168699!5m2!1sen!2sin" 
